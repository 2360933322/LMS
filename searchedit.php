...
<tr>
    ...
    <tr>
    	<td  colspan="9" height="10" align="center"><h1>请输入要修改信息的图书的图书编号</h1></td>
    </tr>
<tr>
    	<td  colspan="9" height="10" >&nbsp;</td>
    </tr>
			...
			<form method="post" action="editform1.php">
				
				<div>
					<label>图书编号：</label><input type="text" name="bookid" />
					<input type="submit" value="点击去修改" />
				</div>
			</form>
<?php	
	}
